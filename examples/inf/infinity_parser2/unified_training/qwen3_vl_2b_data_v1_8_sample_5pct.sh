...
if [ "$NODE_RANK" = "0" ]; then
    ...
    HF_MODEL_PATH="/home/ma-user/work/zuminghuang/03_projects/07_infinity_parser2/ms-swift/output/qwen3_vl_2b_sft_data_v1_8_mcore_pix4k_len32k/v0-20260107-193438/checkpoint-3828"
    ...
    train_path="/home/ma-user/work/data_mllm/new_datasets/swift_merged_datasets/version_v1.8/train_v1.8_sample_5pct.jsonl"
