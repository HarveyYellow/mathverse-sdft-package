...
if [ "$NODE_RANK" = "0" ]; then
    ...
    train_path="['/home/ma-user/work/data_mllm/new_datasets/swift_merged_datasets/version_v1.9/split_subtasks/train_v1.9_sample_5pct_text2md.jsonl', '/home/ma-user/work/data_mllm/new_datasets/swift_merged_datasets/version_v1.9/split_subtasks/train_v1.9_sample_5pct_table2html.jsonl', '/home/ma-user/work/data_mllm/new_datasets/swift_merged_datasets/version_v1.9/split_subtasks/train_v1.9_sample_5pct_table2md.jsonl', '/home/ma-user/work/data_mllm/new_datasets/swift_merged_datasets/version_v1.9/split_subtasks/train_v1.9_sample_5pct_formula2latex.jsonl']"
    ...
    python3 -m verl.trainer.main_ppo --config-path=config \
        ...
        actor_rollout_ref.rollout.log_prob_max_token_len_per_gpu=25000 \
