...
if [ "$NODE_RANK" = "0" ]; then
    ...
    train_path="['/home/ma-user/work/data_mllm/new_datasets/swift_merged_datasets/version_v1.9/split_subtasks/train_v1.9_sample_5pct_doc2json.jsonl', '/home/ma-user/work/data_mllm/new_datasets/swift_merged_datasets/version_v1.9/split_subtasks/train_v1.9_sample_5pct_doc2md.jsonl']"
