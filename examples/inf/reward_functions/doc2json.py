...
class DocumentParserReward:
    ...
    def calculate_category_iou(
        self, gt_items: List[Dict], pred_items: List[Dict], category: str
    ) -> float:
        """
    ...
    def __call__(self, gt_str: str, pred_str: str) -> float:
        """
        计算总奖励
...
if __name__ == "__main__":
    ...
    print(
        f"文本相似度奖励: {reward_fn.calculate_text_similarity_reward(gt_data, pred_data):.4f}"
    )
