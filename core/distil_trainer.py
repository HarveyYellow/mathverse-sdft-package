...
class DistilTrainer(BaseTrainer):
    ...
    def _generate_and_score_completions(
        ...
        student_encode_kwargs = {}
        if images is not None:
            student_encode_kwargs["images"] = images
        ...
        student_inputs = super()._prepare_inputs(
            {"input_ids": student_inputs["input_ids"], "attention_mask": student_inputs["attention_mask"]}
        )
        ...
        teacher_encode_kwargs = {}
        if images is not None:
            teacher_encode_kwargs["images"] = images
        ...
        teacher_inputs = super()._prepare_inputs(
            {"input_ids": teacher_inputs["input_ids"], "attention_mask": teacher_inputs["attention_mask"]}
        )
        if self.use_vllm:
